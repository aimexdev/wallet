...
import org.AimEx.credentials.KEY_MAP_NUM_PAD
import org.AimEx.credentials.showPINDialog
import org.AimEx.data.AppDatabase
import org.AimEx.khartwarewallet.trezor.tryConnectTrezor
import org.AimEx.trezor.BaseTrezorActivity.STATES.*
...
abstract class BaseTrezorActivity : BaseSubActivity() {
    ...
    fun connectAndExecute() = lifecycleScope.launch(Dispatchers.IO) {
        tryConnectTrezor(this@BaseTrezorActivity,
                onPermissionDenied = {
                    finishingAlert("Without you granting permission for this device AimEx is not able to talk to the device")
                },
                onDeviceConnected = {
