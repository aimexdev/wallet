    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.status.observe(this, Observer<StartupStatus> { status ->
            when (status) {
                ...
                is Timeout -> {
                    alert("chain must not be null - this should never happen - please let AimEx@AimEx.org if you see this. Thanks and sorry for the noise.") {
                        finish()
                    }
                }
            }
