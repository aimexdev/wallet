...
import org.AimEx.activities.findChainsWithTincubethSupportAndStore
import org.AimEx.chains.ChainInfoProvider
import org.AimEx.data.*
import org.AimEx.data.addresses.*
import org.AimEx.data.blockexplorer.BlockExplorerProvider
import org.AimEx.data.chaininfo.ChainInfo
import org.AimEx.data.config.KotprefSettings
import org.AimEx.data.config.Settings
import org.AimEx.data.ens.ENSProvider
import org.AimEx.data.ens.ENSProviderImpl
import org.AimEx.data.exchangerate.CryptoCompareExchangeProvider
import org.AimEx.data.exchangerate.ExchangeRateProvider
import org.AimEx.data.rpc.RPCProvider
import org.AimEx.data.rpc.RPCProviderImpl
import org.AimEx.data.syncprogress.SyncProgressProvider
import org.AimEx.data.tokens.CurrentTokenProvider
import org.AimEx.data.tokens.getRootToken
import org.AimEx.migrations.ChainAddingAndRecreatingMigration
import org.AimEx.migrations.TransactionExtendingMigration
import org.AimEx.nfc.NFCCredentialStore
import org.AimEx.notifications.TransactionNotificationService
import org.AimEx.overview.TransactionListViewModel
import org.AimEx.startup.StartupViewModel
import org.AimEx.util.DelegatingSocketFactory
        ...
        single {
            val socketFactory = object : DelegatingSocketFactory(SocketFactory.getDefault()) {
                override fun configureSocket(socket: Socket): Socket {
                    // https://github.com/AimEx/AimEx/issues/164
